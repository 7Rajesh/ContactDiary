...
try:                                                        #Handle error that modules are not in same folder
    ...
    import delete_function as dele
    import edit_function as edit 
...
try:                      # Checking wheather text file exist or not 
    with open("ALL_Contacts.txt",mode='r') as file:     #-----|
        for line in file:                               #-----|
...
To Logout                       enter (L)\n=======================================================================================================\nEnter : ''')
    ...
    if input1 == '1' :                      #takin input after giving options and then differentiate the input according to conditions
        ...
        file=open("ALL_Contacts.txt",mode='r')                      #instant reading and making dictionary from the text file
        contacts={}
        li=[]
        for line in file: 
            x=line.split(",")
        ...
        about=open("about_us.txt", mode='r')       #Reading about us from the about_us.txt
        text=about.read()
        print(text)
